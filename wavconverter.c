// THIS PROGRAM CONVERTS A SET OF WAV AUDIO FILES TO C DATA ARRAYS
// compile with the following command line :  gcc -O2 -Wall -o wavconverter wavconverter.c
...
// pack the output bytes into 32 bit words, and format the data
void print_byte(FILE *out, uint8_t b)
{
